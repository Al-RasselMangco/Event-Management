    ...
    <div class="owl-carousel owl-banner">
      <div class="item item-1">
        <div class="header-text">
          <span class="category">MSU-Marawi, <em>MSU Cafeteria</em></span>
          <h2>Hurry!<br>Get the Best Venue for you</h2>
        </div>
      </div>
      <div class="item item-2">
        <div class="header-text">
          <span class="category">MSU-Marawi, <em>MSU ICC</em></span>
          <h2>Be Quick!<br>Get the best Venue in the Campus</h2>
        </div>
      </div>
      <div class="item item-3">
        <div class="header-text">
          <span class="category">MSU-Marawi, <em>MSU Dimaporo Gym</em></span>
          <h2>Act Now!<br>Get the fun venue for celebration</h2>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="left-image">
            ...
            <a href="property-details.html"><img src="{{ asset('assets/images/featured-icon.png') }}" alt="" style="max-width: 60px; padding: 0px;"></a>
          </div>
        </div>
        <div class="col-lg-5">
          <div class="section-heading">
            <h6>| Popular right now</h6>
            <h2>Best Venue for celebrations</h2>
          </div>
          ...
          <div class="tabs-content">
            <div class="row">
              <div class="nav-wrapper ">
                <ul class="nav nav-tabs" role="tablist">
                  <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="appartment-tab" data-bs-toggle="tab" data-bs-target="#appartment" type="button" role="tab" aria-controls="appartment" aria-selected="true">MSU ICC</button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="villa-tab" data-bs-toggle="tab" data-bs-target="#villa" type="button" role="tab" aria-controls="villa" aria-selected="false">MSU Pavillion</button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="penthouse-tab" data-bs-toggle="tab" data-bs-target="#penthouse" type="button" role="tab" aria-controls="penthouse" aria-selected="false">MSU Dimaporo gyn</button>
                  </li>
                  <li class="nav-item" role="presentation">
              ...
              <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="slh" role="tabpanel" aria-labelledby="slh-tab">
                  <div class="row">
                    <div class="col-lg-3">
                      <div class="info-table">
                        <ul>
                          <li>Total Flat Space <span>200 m2</span></li>
                          <li>Floor number <span>20th</span></li>
                          <li>Number of rooms <span>5</span></li>
                          <li>Parking Available <span>Yes</span></li>
                          <li>Payment Process <span>Bank</span></li>
                        </ul>
                    ...
                    <div class="col-lg-6">
                      <img src="{{ asset('assets/images/deal-04.jpg') }}" alt="">
                    </div>
                    <div class="col-lg-3">
